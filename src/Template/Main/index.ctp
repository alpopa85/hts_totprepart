    ...
    <div class="intro-content swib-maintext">
        ...
        <ul class="main-ul">
            ...
            <li class="py-5 no-marker">
                ...
                <h5>Snowfall, defined as the amount of snow that falls over a particular area (also known as deep drainage or deep percolation) is an important hydrological process in many areas of the world. Snowfall, and by extension the snow cover, snowpack and snowmelt processes can for example play a significant role in replenishing water supplies (i.e., groundwater recharge; surface runoff), provide a reflective cover for the ground surface (and thus helps regulating the Earth's surface temperature) and provide critical habitat elements for many species of plants and animals. Similarly, rainfall, the dominant form of precipitation at global scale, is a key hydrological process, vital for sustaining life and socio-economic systems.</h5>
