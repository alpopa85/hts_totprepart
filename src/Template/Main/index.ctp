    ...
    <div class="intro-content swib-maintext">
        ...
        <ul class="main-ul">
            ...
            <li class="py-5 no-marker">
                ...
                <h5>Knowledge of snowfall and precipitation amounts are important for studies involving for example surface and subsurface hydrology, water resource planning, water (surface water and groundwater) quantity and contaminant transport modelling, irrigation, climate change, etc. Snowfall amount can be obtained from in situ measurements or from various public databases (e.g., weather stations). However, in many cases direct measurement of snowfall can be challenging or might be subject to errors. In many other cases, snowfall and rainfall amounts required for subsequent analyses are simply not available (e.g., not measured). For cases when snowfall and rainfall amounts are not available, TotPrePart provides a methodology for using air temperature and total precipitation to estimate the proportions of snowfall and rainfall based on total precipitation timeseries (i.e., precipitation partitioning).</h5>
