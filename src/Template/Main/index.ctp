    ...
    <div class="intro-content swib-maintext">
        ...
        <ul class="main-ul">
            <li class="py-5 no-marker">
                ...
                <h5><span style="font-style:italic">Danielescu S (2025) TotPrePart - An online tool for partitioning of total precipitation into snowfall and rainfall. Reference Manual.</span>
            ...
            <li class="py-5 no-marker">
                ...
                <h5>Knowledge of snowfall and precipitation amounts is important for studies involving for example surface and subsurface hydrology, water resource planning, water (surface water and groundwater) quantity and contaminant transport modelling, irrigation, climate change, etc. Snowfall amount can be obtained from in situ measurements or from various public databases (e.g., weather stations). However, in many cases direct measurement of snowfall can be challenging or might be subject to errors. In many other cases, snowfall and rainfall amounts required for subsequent analyses are simply not available (e.g., not measured). For cases when snowfall and rainfall amounts are not available, TotPrePart provides a methodology for estimating the proportions of snowfall and rainfall based on daily air temperature and total precipitation timeseries (i.e., precipitation partitioning).</h5>
                ...
                <h5>TotPrePart has a broad range of applicability and can be used for standalone analyses of snow and rainfall related processes, for generation of critical data for external models that allow for uploading of user-provided snowfall and rainfall timeseries; or for educational purposes to demonstrate the significance and the dynamics of rainfall and snowfall or rainfall and snowfall dependent processes.</h5>
                <div class="text-right"><a href="#contents">&rarr; Table of Contents</a></div>        
