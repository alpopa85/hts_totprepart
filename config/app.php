...
return [
     ...
     */
    'Error' => [
        'errorLevel' => E_ALL & ~E_NOTICE & ~E_STRICT & ~E_DEPRECATED & ~E_USER_DEPRECATED,
    ...
    'Session' => [
        ...
        // 'cookie' => 'SWASIRBACOOKIE',
        'ini' => [
            // 'session.cookie_lifetime' => 1800, // Valid for 30 minutes
            // 'session.gc_maxlifetime' => 1800,
            // 'session.gc_probability' => 1,
            // 'session.gc_divisor' => 100,
            // 'session.cookie_httponly' => true, // REMOVE FROM PROD
            'session.cookie_secure' => false // REMOVE FROM PROD
        ],                
    ],
];
